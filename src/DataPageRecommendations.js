...
const DataPageRecommendations = (props) => {
  ...
  const [exploratoryRecommendationSongs, setExploratoryRecommendationSongs] =
    useState([]);
  ...
  useEffect(() => {
    ...
    getSongRecommendations(
      setExploratoryRecommendationSongs,
  ...
  return (
    <div>
      ...
      <div
        style={{ fontWeight: "bold", fontSize: "12px", marginBottom: "10px" }}
      >
